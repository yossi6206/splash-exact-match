...
export const JobFilters = () => {
  return (
    <div className="bg-card/95 backdrop-blur-md rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-border p-6 mb-6 sticky top-20 z-10">
