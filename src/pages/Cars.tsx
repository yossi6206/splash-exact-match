          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex items-center justify-center gap-8 pt-4 animate-fade-in animation-delay-600">
              <div className="text-center hover-scale cursor-default">
                <div className="text-3xl font-bold text-white transition-all duration-300">110+</div>
                <div className="text-sm text-white/80">רכבים זמינים</div>
              </div>
              <div className="w-px h-12 bg-white/30" />
              <div className="text-center hover-scale cursor-default">
                <div className="text-3xl font-bold text-white transition-all duration-300">15+</div>
                <div className="text-sm text-white/80">יצרנים</div>
              </div>
              <div className="w-px h-12 bg-white/30" />
              <div className="text-center hover-scale cursor-default">
                <div className="text-3xl font-bold text-white transition-all duration-300">100%</div>
