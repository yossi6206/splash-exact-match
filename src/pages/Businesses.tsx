...
import { Search, Building2, Loader2, Filter } from "lucide-react";
          ...
          <div className="max-w-4xl mx-auto text-center space-y-4 md:space-y-8">
            ...
            <div className="flex md:hidden items-center justify-center gap-4 pt-2">
              <div className="text-center">
                ...
                <div className="text-xs text-white/80">עסקים</div>
              </div>
              <div className="w-px h-8 bg-white/30" />
              <div className="text-center">
                <div className="text-lg font-bold text-white">מגוון</div>
                <div className="text-xs text-white/80">קטגוריות</div>
              </div>
              <div className="w-px h-8 bg-white/30" />
              <div className="text-center">
                <div className="text-lg font-bold text-white">מאומתים</div>
                <div className="text-xs text-white/80">עסקים</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[300px] overflow-y-auto">
                <SheetHeader>
                  <SheetTitle>סינון עסקים</SheetTitle>
                </SheetHeader>
                <div className="mt-4">
          ...
          <div className="space-y-4">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-64">
                <Building2 className="w-12 h-12 md:w-16 md:h-16 text-muted-foreground mb-4" />
                <p className="text-base md:text-lg text-muted-foreground">לא נמצאו עסקים</p>
              </div>
            ) : (
