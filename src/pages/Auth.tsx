          ...
          <div className="bg-card border border-border rounded-2xl shadow-lg p-8 md:p-10">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <Button
                type="button"
                variant="outline"
                className="h-11 border border-border hover:bg-muted hover:border-primary/50 transition-all group"
                onClick={handleGoogleSignIn}
              >
                <svg className="ml-2 w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24">
              ...
              <Button
                ...
                className="h-11 border border-border hover:bg-muted hover:border-primary/50 transition-all group"
              >
                <svg className="ml-2 w-5 h-5 group-hover:scale-110 transition-transform" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-3 bg-card text-muted-foreground">או התחבר ידנית</span>
              </div>
            </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="h-11 text-right bg-background"
                    required
                  />
                  {errors.loginEmail && (
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="h-11 text-right pr-10 bg-background"
                      required
                    />
                    <button
                      type="button"
