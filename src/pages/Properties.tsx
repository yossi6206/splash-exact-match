        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex items-center justify-center gap-8 pt-4 animate-fade-in animation-delay-600">
              ...
              <div className="text-center hover-scale cursor-default">
                <div className="text-3xl font-bold text-white transition-all duration-300">17+</div>
                <div className="text-sm text-white/80">ערים</div>
              </div>
              <div className="w-px h-12 bg-white/30" />
              <div className="text-center hover-scale cursor-default">
                <div className="text-3xl font-bold text-white transition-all duration-300">98%</div>
